...
public class CTRNN {
	...
	public CTRNN(){
		...
		weights = new double[Parameters.VECTOR_LENGTH];
	}
	...
	public BeerVector chooseAction(BeerBoard board){
		...
		for (int i = 0; i < this.outputs.length; i++) {
			...
			//outputs[i] = sign.fire(inputs, Arrays.copyOfRange(weights,i*temp2, i*temp2+temp2), weights[(weights.length-1)-i]);
		}
